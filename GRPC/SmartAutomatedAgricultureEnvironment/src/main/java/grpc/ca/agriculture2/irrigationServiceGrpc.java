...
public final class irrigationServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<grpc.ca.agriculture2.IrrigationParametersRequest,
      grpc.ca.agriculture2.IrrigationStatusResponse> getSetIrrigationMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "SetIrrigation",
      requestType = grpc.ca.agriculture2.IrrigationParametersRequest.class,
      responseType = grpc.ca.agriculture2.IrrigationStatusResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<grpc.ca.agriculture2.IrrigationParametersRequest,
      grpc.ca.agriculture2.IrrigationStatusResponse> getSetIrrigationMethod() {
    io.grpc.MethodDescriptor<grpc.ca.agriculture2.IrrigationParametersRequest, grpc.ca.agriculture2.IrrigationStatusResponse> getSetIrrigationMethod;
      ...
      synchronized (irrigationServiceGrpc.class) {
        if ((getSetIrrigationMethod = irrigationServiceGrpc.getSetIrrigationMethod) == null) {
          irrigationServiceGrpc.getSetIrrigationMethod = getSetIrrigationMethod = 
              io.grpc.MethodDescriptor.<grpc.ca.agriculture2.IrrigationParametersRequest, grpc.ca.agriculture2.IrrigationStatusResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(
                  "smartAgriculture.irrigationService", "SetIrrigation"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  grpc.ca.agriculture2.IrrigationParametersRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  grpc.ca.agriculture2.IrrigationStatusResponse.getDefaultInstance()))
  ...
  private static volatile io.grpc.MethodDescriptor<grpc.ca.agriculture2.LocationParametersRequest,
      grpc.ca.agriculture2.CurrentStatusResponse> getGetIrrigStatusMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "GetIrrigStatus",
      requestType = grpc.ca.agriculture2.LocationParametersRequest.class,
      responseType = grpc.ca.agriculture2.CurrentStatusResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.SERVER_STREAMING)
  public static io.grpc.MethodDescriptor<grpc.ca.agriculture2.LocationParametersRequest,
      grpc.ca.agriculture2.CurrentStatusResponse> getGetIrrigStatusMethod() {
    io.grpc.MethodDescriptor<grpc.ca.agriculture2.LocationParametersRequest, grpc.ca.agriculture2.CurrentStatusResponse> getGetIrrigStatusMethod;
      ...
      synchronized (irrigationServiceGrpc.class) {
        if ((getGetIrrigStatusMethod = irrigationServiceGrpc.getGetIrrigStatusMethod) == null) {
          irrigationServiceGrpc.getGetIrrigStatusMethod = getGetIrrigStatusMethod = 
              io.grpc.MethodDescriptor.<grpc.ca.agriculture2.LocationParametersRequest, grpc.ca.agriculture2.CurrentStatusResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.SERVER_STREAMING)
              .setFullMethodName(generateFullMethodName(
                  "smartAgriculture.irrigationService", "GetIrrigStatus"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  grpc.ca.agriculture2.LocationParametersRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  grpc.ca.agriculture2.CurrentStatusResponse.getDefaultInstance()))
  ...
  private static volatile io.grpc.MethodDescriptor<grpc.ca.agriculture2.CancelationRequest,
      grpc.ca.agriculture2.CancelationResponse> getCancelIrrigationMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "CancelIrrigation",
      requestType = grpc.ca.agriculture2.CancelationRequest.class,
      responseType = grpc.ca.agriculture2.CancelationResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.BIDI_STREAMING)
  public static io.grpc.MethodDescriptor<grpc.ca.agriculture2.CancelationRequest,
      grpc.ca.agriculture2.CancelationResponse> getCancelIrrigationMethod() {
    io.grpc.MethodDescriptor<grpc.ca.agriculture2.CancelationRequest, grpc.ca.agriculture2.CancelationResponse> getCancelIrrigationMethod;
      ...
      synchronized (irrigationServiceGrpc.class) {
        if ((getCancelIrrigationMethod = irrigationServiceGrpc.getCancelIrrigationMethod) == null) {
          irrigationServiceGrpc.getCancelIrrigationMethod = getCancelIrrigationMethod = 
              io.grpc.MethodDescriptor.<grpc.ca.agriculture2.CancelationRequest, grpc.ca.agriculture2.CancelationResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.BIDI_STREAMING)
              .setFullMethodName(generateFullMethodName(
                  "smartAgriculture.irrigationService", "CancelIrrigation"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  grpc.ca.agriculture2.CancelationRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  grpc.ca.agriculture2.CancelationResponse.getDefaultInstance()))
  ...
  public static abstract class irrigationServiceImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void setIrrigation(grpc.ca.agriculture2.IrrigationParametersRequest request,
        io.grpc.stub.StreamObserver<grpc.ca.agriculture2.IrrigationStatusResponse> responseObserver) {
      asyncUnimplementedUnaryCall(getSetIrrigationMethod(), responseObserver);
    }

    /**
     */
    public void getIrrigStatus(grpc.ca.agriculture2.LocationParametersRequest request,
        io.grpc.stub.StreamObserver<grpc.ca.agriculture2.CurrentStatusResponse> responseObserver) {
      asyncUnimplementedUnaryCall(getGetIrrigStatusMethod(), responseObserver);
    }

    /**
     */
    public io.grpc.stub.StreamObserver<grpc.ca.agriculture2.CancelationRequest> cancelIrrigation(
        io.grpc.stub.StreamObserver<grpc.ca.agriculture2.CancelationResponse> responseObserver) {
    ...
    @java.lang.Override public final io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            asyncUnaryCall(
              new MethodHandlers<
                grpc.ca.agriculture2.IrrigationParametersRequest,
                grpc.ca.agriculture2.IrrigationStatusResponse>(
                  this, METHODID_SET_IRRIGATION)))
          .addMethod(
            getGetIrrigStatusMethod(),
            asyncServerStreamingCall(
              new MethodHandlers<
                grpc.ca.agriculture2.LocationParametersRequest,
                grpc.ca.agriculture2.CurrentStatusResponse>(
                  this, METHODID_GET_IRRIG_STATUS)))
          .addMethod(
            getCancelIrrigationMethod(),
            asyncBidiStreamingCall(
              new MethodHandlers<
                grpc.ca.agriculture2.CancelationRequest,
                grpc.ca.agriculture2.CancelationResponse>(
  ...
  public static final class irrigationServiceBlockingStub extends io.grpc.stub.AbstractStub<irrigationServiceBlockingStub> {
    ...
    /**
     */
    public grpc.ca.agriculture2.IrrigationStatusResponse setIrrigation(grpc.ca.agriculture2.IrrigationParametersRequest request) {
    ...
    /**
     */
    public java.util.Iterator<grpc.ca.agriculture2.CurrentStatusResponse> getIrrigStatus(
        grpc.ca.agriculture2.LocationParametersRequest request) {
  ...
  public static final class irrigationServiceFutureStub extends io.grpc.stub.AbstractStub<irrigationServiceFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<grpc.ca.agriculture2.IrrigationStatusResponse> setIrrigation(
        grpc.ca.agriculture2.IrrigationParametersRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_SET_IRRIGATION:
          serviceImpl.setIrrigation((grpc.ca.agriculture2.IrrigationParametersRequest) request,
              (io.grpc.stub.StreamObserver<grpc.ca.agriculture2.IrrigationStatusResponse>) responseObserver);
          break;
        case METHODID_GET_IRRIG_STATUS:
          serviceImpl.getIrrigStatus((grpc.ca.agriculture2.LocationParametersRequest) request,
              (io.grpc.stub.StreamObserver<grpc.ca.agriculture2.CurrentStatusResponse>) responseObserver);
          break;
        default:
  ...
  private static abstract class irrigationServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return grpc.ca.agriculture2.IrrigationService.getDescriptor();
    }
