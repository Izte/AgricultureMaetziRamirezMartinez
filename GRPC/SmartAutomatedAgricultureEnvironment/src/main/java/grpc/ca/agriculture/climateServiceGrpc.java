...
public final class climateServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<grpc.ca.agriculture.TemperatureRequest,
      grpc.ca.agriculture.TemperatureResponse> getGetTemperatureMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "GetTemperature",
      requestType = grpc.ca.agriculture.TemperatureRequest.class,
      responseType = grpc.ca.agriculture.TemperatureResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<grpc.ca.agriculture.TemperatureRequest,
      grpc.ca.agriculture.TemperatureResponse> getGetTemperatureMethod() {
    io.grpc.MethodDescriptor<grpc.ca.agriculture.TemperatureRequest, grpc.ca.agriculture.TemperatureResponse> getGetTemperatureMethod;
      ...
      synchronized (climateServiceGrpc.class) {
        if ((getGetTemperatureMethod = climateServiceGrpc.getGetTemperatureMethod) == null) {
          climateServiceGrpc.getGetTemperatureMethod = getGetTemperatureMethod = 
              io.grpc.MethodDescriptor.<grpc.ca.agriculture.TemperatureRequest, grpc.ca.agriculture.TemperatureResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(
                  "smartAgriculture.climateService", "GetTemperature"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  grpc.ca.agriculture.TemperatureRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  grpc.ca.agriculture.TemperatureResponse.getDefaultInstance()))
  ...
  private static volatile io.grpc.MethodDescriptor<grpc.ca.agriculture.HumidityRequest,
      grpc.ca.agriculture.HumidityResponse> getGetHumidityMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "GetHumidity",
      requestType = grpc.ca.agriculture.HumidityRequest.class,
      responseType = grpc.ca.agriculture.HumidityResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<grpc.ca.agriculture.HumidityRequest,
      grpc.ca.agriculture.HumidityResponse> getGetHumidityMethod() {
    io.grpc.MethodDescriptor<grpc.ca.agriculture.HumidityRequest, grpc.ca.agriculture.HumidityResponse> getGetHumidityMethod;
      ...
      synchronized (climateServiceGrpc.class) {
        if ((getGetHumidityMethod = climateServiceGrpc.getGetHumidityMethod) == null) {
          climateServiceGrpc.getGetHumidityMethod = getGetHumidityMethod = 
              io.grpc.MethodDescriptor.<grpc.ca.agriculture.HumidityRequest, grpc.ca.agriculture.HumidityResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(
                  "smartAgriculture.climateService", "GetHumidity"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  grpc.ca.agriculture.HumidityRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  grpc.ca.agriculture.HumidityResponse.getDefaultInstance()))
  ...
  private static volatile io.grpc.MethodDescriptor<grpc.ca.agriculture.RainfallRequest,
      grpc.ca.agriculture.RainfallResponse> getGetRainMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "GetRain",
      requestType = grpc.ca.agriculture.RainfallRequest.class,
      responseType = grpc.ca.agriculture.RainfallResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<grpc.ca.agriculture.RainfallRequest,
      grpc.ca.agriculture.RainfallResponse> getGetRainMethod() {
    io.grpc.MethodDescriptor<grpc.ca.agriculture.RainfallRequest, grpc.ca.agriculture.RainfallResponse> getGetRainMethod;
    if ((getGetRainMethod = climateServiceGrpc.getGetRainMethod) == null) {
      synchronized (climateServiceGrpc.class) {
        if ((getGetRainMethod = climateServiceGrpc.getGetRainMethod) == null) {
          climateServiceGrpc.getGetRainMethod = getGetRainMethod = 
              io.grpc.MethodDescriptor.<grpc.ca.agriculture.RainfallRequest, grpc.ca.agriculture.RainfallResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(
                  "smartAgriculture.climateService", "GetRain"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  grpc.ca.agriculture.RainfallRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  grpc.ca.agriculture.RainfallResponse.getDefaultInstance()))
  ...
  public static abstract class climateServiceImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void getTemperature(grpc.ca.agriculture.TemperatureRequest request,
        io.grpc.stub.StreamObserver<grpc.ca.agriculture.TemperatureResponse> responseObserver) {
      asyncUnimplementedUnaryCall(getGetTemperatureMethod(), responseObserver);
    }

    /**
     */
    public void getHumidity(grpc.ca.agriculture.HumidityRequest request,
        io.grpc.stub.StreamObserver<grpc.ca.agriculture.HumidityResponse> responseObserver) {
      asyncUnimplementedUnaryCall(getGetHumidityMethod(), responseObserver);
    }

    /**
     */
    public void getRain(grpc.ca.agriculture.RainfallRequest request,
        io.grpc.stub.StreamObserver<grpc.ca.agriculture.RainfallResponse> responseObserver) {
    ...
    @java.lang.Override public final io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            asyncUnaryCall(
              new MethodHandlers<
                grpc.ca.agriculture.TemperatureRequest,
                grpc.ca.agriculture.TemperatureResponse>(
                  this, METHODID_GET_TEMPERATURE)))
          .addMethod(
            getGetHumidityMethod(),
            asyncUnaryCall(
              new MethodHandlers<
                grpc.ca.agriculture.HumidityRequest,
                grpc.ca.agriculture.HumidityResponse>(
                  this, METHODID_GET_HUMIDITY)))
          .addMethod(
            getGetRainMethod(),
            asyncUnaryCall(
              new MethodHandlers<
                grpc.ca.agriculture.RainfallRequest,
                grpc.ca.agriculture.RainfallResponse>(
  ...
  public static final class climateServiceBlockingStub extends io.grpc.stub.AbstractStub<climateServiceBlockingStub> {
    ...
    /**
     */
    public grpc.ca.agriculture.TemperatureResponse getTemperature(grpc.ca.agriculture.TemperatureRequest request) {
    ...
    /**
     */
    public grpc.ca.agriculture.HumidityResponse getHumidity(grpc.ca.agriculture.HumidityRequest request) {
      return blockingUnaryCall(
    ...
    /**
     */
    public grpc.ca.agriculture.RainfallResponse getRain(grpc.ca.agriculture.RainfallRequest request) {
      return blockingUnaryCall(
  ...
  public static final class climateServiceFutureStub extends io.grpc.stub.AbstractStub<climateServiceFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<grpc.ca.agriculture.TemperatureResponse> getTemperature(
        grpc.ca.agriculture.TemperatureRequest request) {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<grpc.ca.agriculture.HumidityResponse> getHumidity(
        grpc.ca.agriculture.HumidityRequest request) {
      return futureUnaryCall(
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<grpc.ca.agriculture.RainfallResponse> getRain(
        grpc.ca.agriculture.RainfallRequest request) {
      return futureUnaryCall(
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_GET_TEMPERATURE:
          serviceImpl.getTemperature((grpc.ca.agriculture.TemperatureRequest) request,
              (io.grpc.stub.StreamObserver<grpc.ca.agriculture.TemperatureResponse>) responseObserver);
          break;
        case METHODID_GET_HUMIDITY:
          serviceImpl.getHumidity((grpc.ca.agriculture.HumidityRequest) request,
              (io.grpc.stub.StreamObserver<grpc.ca.agriculture.HumidityResponse>) responseObserver);
          break;
        case METHODID_GET_RAIN:
          serviceImpl.getRain((grpc.ca.agriculture.RainfallRequest) request,
              (io.grpc.stub.StreamObserver<grpc.ca.agriculture.RainfallResponse>) responseObserver);
          break;
        default:
  ...
  private static abstract class climateServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return grpc.ca.agriculture.ClimateService.getDescriptor();
    }
